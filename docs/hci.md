...
١- تصميم واجهة المستخدم UI
٢- تصميم تجربة المستخدم UX
٣- تقييم اليوزابيليتي 
٤- ابحاث المستخدم UR
٥- تصميم البروتوتايب أو النماذج الأولية
٦- تصميم التفاعل الصوتي VUI
٧- تصميم تفاعل الأجهزة القابلة للارتداء Wearable 
٨- تصميم التجارب الافتراضية والمعززة AR/VR 
٩- التصميم المقنع (خليني اقول ذي مهارة مو مجال)
١٠- تصميم نظام التصميم Design systems 
١١- تصميم الاكسسبلتي (برضو ذي تحسب مهارة)
١٢- ربط التفاعل الإنساني بالذكاء الاصناعي 
١٣- تصميم المنتج PD
١٤- ادارة المشاريع PM
١٥- تصميم التفاعل الطبيعي (متعدد الحواس)
١٦- هيكلة المعلومات IA
### المهارات الداعمة  
...
-مهارات التواصل.
- الرسم التخطيط البسيط(Sketching).
