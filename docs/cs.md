...
| **تصنيف المهارة**  | **المهارات المكتسبة** |
| ------------- | ------------- |
| البرمجة والتطوير | • كتابة برامج باستخدام جافا (من الأساسيات إلى البرمجة المتقدمة). | 
| البرمجة والتطوير | • تصميم خوارزميات فعالة (مثل البحث والفرز) وهياكل بيانات (مثل القوائم والأشجار). | 
| تطوير الويب وقواعد البيانات | • بناء مواقع وتطبيقات ويب متكاملة. |
| تطوير الويب وقواعد البيانات |  • تصميم وإدارة قواعد البيانات (SQL مثل) وحفظ البيانات بأمان. |
| الأمن السيبراني والشبكات | • فهم كيفية حماية الأنظمة من الاختراقات. |
| الأمن السيبراني والشبكات | • التعامل مع بروتوكولات الشبكات ونقل البيانات بين الأجهزة. |
| الذكاء الاصطناعي وتعلم الآلة | • تطوير برامج ذكية تُحلِّل البيانات وتتعلَّم تلقائيًّا (مثل التوصيات أو التنبؤات). |
| إدارة المشاريع والأنظمة | • تعلم دورة حياة البرنامج و تنفيذ مشاريع برمجية من التصميم حتى التشغيل . |
| دارة المشاريع والأنظمة | • استخدام الحوسبة السحابية (مثل تخزين البيانات عبر الإنترنت). | 
| مهارات عملية وعامة | • العمل ضمن فريق لبناء مشاريع مشتركة. |
| مهارات عملية وعامة | • تحليل المشكلات المعقدة وتقسيمها إلى مهام أصغر قابلة للحل. |
| مهارات عملية وعامة | •(pseudocode)  شرح الأفكار التقنية بلغة بسيطة وجعلها كخوارزمية بلغة مثل . |
