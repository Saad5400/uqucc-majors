...
export default function Hero({ badge = 'مبادرة طلابية غير رسمية', title, subtitle, primaryCtaLabel = 'استكشف التخصصات', primaryCtaHref = '#majors', secondaryCtaLabel = 'تجارب الطلاب', secondaryCtaHref = '/blog', }) {
