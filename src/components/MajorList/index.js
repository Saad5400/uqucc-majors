...
import { LuCpu, LuNetwork, LuCode, LuDatabase, LuShieldCheck, LuBrainCircuit, LuMousePointerClick, LuArrowLeft, } from 'react-icons/lu';
...
export default function MajorList() {
    return (<ul className={styles.list}>
      {majors.map(({ id, label, description, href, Icon }) => (<li key={id} className={styles.item}>
