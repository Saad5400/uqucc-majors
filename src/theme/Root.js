...
function useTocAutoScroll() {
    ...
    useEffect(() => {
        ...
        const findToc = () => document.querySelector('.table-of-contents');
        const findActiveLink = (toc) => toc.querySelector('.table-of-contents__link--active');
        const scrollActiveIntoView = () => {
            ...
            if (above || below) {
                const target = active.offsetTop - toc.clientHeight / 2 + active.clientHeight / 2;
